...
<div class="giiant-crud case-category-view">
    ...
    <div class="clearfix crud-navigation">
        ...
        <div class='pull-left'>
            ...
            ['create', 'id' => $model->id, 'CaseCategory'=>$copyParams],
    ...
    'content' => $this->blocks['app\models\CaseCategory'],
    'active'  => true,
], ]
                 ]
    );
