...
<div class="giiant-crud outcome-category-view">
    ...
    <div class="clearfix crud-navigation">
        ...
        <div class='pull-left'>
            ...
            ['create', 'id' => $model->id, 'OutcomeCategory'=>$copyParams],
    ...
    <?php $this->beginBlock('app\models\OutcomeCategory'); ?>
    ...
    'content' => $this->blocks['app\models\OutcomeCategory'],
    'active'  => true,
], ]
                 ]
    );
