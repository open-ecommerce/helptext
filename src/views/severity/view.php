...
<div class="giiant-crud severity-view">
    ...
    <div class="clearfix crud-navigation">
        ...
        <div class='pull-left'>
            ...
            ['create', 'id' => $model->id, 'Severity'=>$copyParams],
    ...
    <?php $this->beginBlock('app\models\Severity'); ?>
    ...
    'content' => $this->blocks['app\models\Severity'],
    'active'  => true,
], ]
                 ]
    );
